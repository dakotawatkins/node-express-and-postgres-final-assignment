...
// modify the create() route handler to call the service method to
// return a 201 status code along with the newly created post.
...
// modify the update() route handler to call the service 
// method and return the updated post upon success.
